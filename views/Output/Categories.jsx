...
export default React.createClass({
  ...
  render() {
    ...
    return (
      <div>
        <OutputTemplate
          description={<p className="base--p_small">Classify content into a <a href="https://www.ibm.com/watson/developercloud/natural-language-understanding/api/v1/#categories" target="_blank" rel="noopener noreferrer">hierarquia</a> that&apos;s five levels deep with a score.</p>}
