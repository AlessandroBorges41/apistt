...
export default React.createClass({
  ...
  render() {
    return (
      <div>
        <OutputTemplate
          description={<p className="base--p_small">Identifies general <a href="https://www.ibm.com/watson/developercloud/natural-language-understanding/api/v1/#concepts" target="_blank" rel="noopener noreferrer">concepts</a> que não podem ser referenciados diretamente no texto.</p>}
